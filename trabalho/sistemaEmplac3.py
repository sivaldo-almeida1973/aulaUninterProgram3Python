...
tabela_hash_estados.inserir_estado('BK', 'Bruno Kostiuk')

# Impressão da tabela hash
print("Tabela Hash antes de inserir qualquer informação:")
tabela_hash_estados.imprimir_tabela()

# Impressão após inserção dos estados e do DF
print("\nApós inserir os estados e o DF:")
tabela_hash_estados.imprimir_tabela()

# Impressão após inserção do estado fictício
print("\nApós inserir o estado fictício:")
tabela_hash_estados.imprimir_tabela()
