...
class Nodo:
    # Método construtor da classe Nodo.
    def __init__(self, numero, cor):
        self.numero = numero   # armazena o número do cartão do paciente.
        self.cor = cor         # armazenar a cor do cartão do paciente (A para amarelo, V para verde).
...
class ListaEncadeada:
    ...
    def chamarPaciente(self):
        if self.head:  # Se houver um paciente na fila...
            ...
            print('Não há pacientes na fila')  # ...imprime uma mensagem informando que a fila está vazia.
...
def menu():
    ...
    numero_amarelo = 201  # Define a numeração inicial para cartões amarelos (A).
    numero_verde = 1       # Define a numeração inicial para cartões verdes (V).
    while True:  # Loop infinito para o menu.
        ...
        if opcao == '1':  # Se a opção for 1...
            cor = input("Digite a cor do cartão (A para amarelo, V para verde): ").upper()  # ...solicita a cor do cartão.
            if cor == 'A':  # Se a cor for amarela...
        ...
        else:  # Se a opção fornecida não for válida...
