...
class Paciente:
    def __init__(self, id, tipo):
        self.id = id           # Identificador numérico do paciente.
        self.tipo = tipo       # Tipo do paciente: 'A' para amarelo ou 'V' para verde.
